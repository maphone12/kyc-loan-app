...
import { TextInputs, UploadImage, SelectBranch, SelectDocument, DatePicker } from './components';
    ...
    <SafeAreaView style={{ 
            ...
            <View style={{
                ...
                <View>
                    ...
                    <Text style={styles.titleH5}>
                        ປ້ອນຂໍ້ມູນຄຳຮ້ອງໃຫ້ຄົບຖ້ວນ, ລະອຽດ ແລະ ຖືກຕ້ອງ.
                    </Text>
        ...
        <View style={{
            ...
            <View style={styles.bottomView}>
                <Buttons btn_text="ຖັດໄປ" on_press={()=>navigation.navigate("Guarantor")} />
            </View>
        </View>
    </SafeAreaView>
